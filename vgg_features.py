...
class VGG_features(nn.Module):
    ...
    def __init__(self, out_channels, cfg, batch_norm=False, init_weights=True, depth=5):
...
def vgg11_features(pretrained=False, **kwargs):
    ...
    model = VGG_features(out_channels, cfg['A'], batch_norm=False, **kwargs)
    if pretrained:
...
def vgg11_bn_features(pretrained=False, **kwargs):
    ...
    if pretrained:
        kwargs['init_weights'] = False
    out_channels = (64, 128, 256, 512, 512, 512)
    model = VGG_features(out_channels, cfg['A'], batch_norm=True, **kwargs)
    if pretrained:
...
def vgg13_features(pretrained=False, **kwargs):
    ...
    if pretrained:
        kwargs['init_weights'] = False
    out_channels = (64, 128, 256, 512, 512, 512)
    model = VGG_features(out_channels, cfg['B'], batch_norm=False, **kwargs)
    if pretrained:
...
def vgg13_bn_features(pretrained=False, **kwargs):
    ...
    if pretrained:
        kwargs['init_weights'] = False
    out_channels = (64, 128, 256, 512, 512, 512)
    model = VGG_features(out_channels, cfg['B'], batch_norm=True, **kwargs)
    if pretrained:
...
def vgg16_features(pretrained=False, **kwargs):
    ...
    if pretrained:
        kwargs['init_weights'] = False
    out_channels = (64, 128, 256, 512, 512, 512)
    model = VGG_features(out_channels, cfg['D'], batch_norm=False, **kwargs)
    if pretrained:
...
def vgg16_bn_features(pretrained=False, **kwargs):
    ...
    if pretrained:
        kwargs['init_weights'] = False
    out_channels = (64, 128, 256, 512, 512, 512)
    model = VGG_features(out_channels, cfg['D'], batch_norm=True, **kwargs)
    if pretrained:
...
def vgg19_features(pretrained=False, **kwargs):
    ...
    if pretrained:
        kwargs['init_weights'] = False
    out_channels = (64, 128, 256, 512, 512, 512)
    model = VGG_features(out_channels, cfg['E'], batch_norm=False, **kwargs)
    if pretrained:
...
def vgg19_bn_features(pretrained=False, **kwargs):
    ...
    if pretrained:
        kwargs['init_weights'] = False
    out_channels = (64, 128, 256, 512, 512, 512)
    model = VGG_features(out_channels, cfg['E'], batch_norm=True, **kwargs)
    if pretrained:
